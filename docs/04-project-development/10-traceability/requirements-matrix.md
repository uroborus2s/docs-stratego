...
| 需求 | 方案 | 实现 | 运维 |
| --- | --- | --- | --- |
| REQ-001 | `02-user-guide/contributor-guide/source-docs-standard.md` | `site_builder.py` | `admin-guide.md` |
| REQ-003 | `technical-selection.md` | `source_sync.py` | `deployment-guide.md` |
| REQ-004 | `system-architecture.md` | `.generated/authz/permissions.json` | `operations-runbook.md` |
...
| REQ-015 | `02-user-guide/contributor-guide/offboarding.md` | `source_admin.py` | `admin-guide.md` |
| REQ-016 | `02-user-guide/contributor-guide/cli.md` | `cli.py`, `source_admin.py` | `configuration.md` |
| REQ-017 | `02-user-guide/contributor-guide/cli.md` | `cli.py`, `source_admin.py` | `usage.md` |
