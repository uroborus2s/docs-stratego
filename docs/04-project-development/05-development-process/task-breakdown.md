...
| TASK-003 | 功能 | 新增 `validate-source-pointer-pr.yml`，把单元测试、`docs-stratego sync --source-mode remote`、`docs-stratego build` 和 `mkdocs build` 收口为 merge gate。 | 后端工程师 / QA 工程师 | 0.5 | `TASK-001` | 指针同步 PR 校验链路 |
